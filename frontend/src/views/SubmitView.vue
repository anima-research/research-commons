  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-950">
    ...
    <div class="lg:ml-64">
      ...
      <div class="bg-white dark:bg-gray-900 rounded-lg shadow border border-gray-200 dark:border-gray-800 p-6 transition-colors">
        ...
        <div v-if="previewMessages.length > 0" class="mb-6 p-4 bg-gray-50 dark:bg-gray-950 rounded">
          ...
          <div class="space-y-1 text-xs text-gray-600 dark:text-gray-400">
            ...
            <div v-if="previewMessages.length > 3" class="text-gray-500 dark:text-gray-400">
